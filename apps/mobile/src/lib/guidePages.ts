...
export const PAGES: GuidePage[] = [
  ...
  { set: "market", glyph: "cube", color: "#A28457", title: "The Workshop mocks it up.", line: "The studio reads what your product is from your words and draws it: the palette, type and shapes its kind has earned, three to five screens with your customers' names on them. With a key, the desk also writes the brief (the product, the person, every screen with its words, the design system) and designs the whole app to it. The brief is the prompt you hand to whatever builds it: Lovable, Base44, Bolt or v0 if you do not code, Claude Code if you do.", tab: "Workshop", tips: ["Write the sign on your stand and talk to five people first; the brief is only as good as what you wrote down.", "Not read right? Tap what it is under the phone; the palette, type and screens follow. Another take turns them all at once.", "Show the picture to the five people you talked to before building anything."] },
