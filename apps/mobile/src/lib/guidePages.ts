...
export const PAGES: GuidePage[] = [
  ...
  { set: "market", glyph: "cube", color: "#A28457", title: "The Workshop mocks it up.", line: "From your sign, your audience and what customers said, the desk draws the first three screens of your product in a phone, writes the build brief, and hands it to whatever builds it: Lovable, Bolt or v0 if you do not code, Claude Code if you do.", tab: "Workshop", tips: ["Write the sign on your stand first; the mock-up is drawn from it.", "Edit any word. The brief and the prompts follow.", "Show the picture to the five people you talked to before building anything."] },
