...
export const PAGES: GuidePage[] = [
  ...
  { set: "market", glyph: "cube", color: "#A28457", title: "The Workshop mocks it up.", line: "From everything you wrote, the desk writes the brief (the product, the person, every screen with its words, a design system) and then designs the first screens of your product in a phone. The brief is the prompt you hand to whatever builds it: Lovable, Bolt or v0 if you do not code, Claude Code if you do.", tab: "Workshop", tips: ["Write the sign on your stand and talk to five people first; the brief is only as good as what you wrote down.", "Edit any word. The brief and the prompts follow.", "Show the picture to the five people you talked to before building anything."] },
