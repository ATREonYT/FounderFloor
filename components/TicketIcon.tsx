...
export default function TicketIcon({ size = 14 }: { size?: number }) {
  return (
    ...
    >
      {/* body */}
      <rect x="1" y="4" width="14" height="8" fill="var(--gold)" />
      ...
      <rect x="0" y="7" width="2" height="2" fill="var(--paper)" />
      <rect x="14" y="7" width="2" height="2" fill="var(--paper)" />
      ...
      <rect x="4" y="9" width="1" height="1" fill="var(--paper)" opacity="0.6" />
      <rect x="6" y="9" width="1" height="1" fill="var(--paper)" opacity="0.6" />
      {/* stub tick */}
